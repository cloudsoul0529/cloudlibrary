...
-- 二号用户 2u 2
-- ---------------------------
INSERT INTO `user` VALUES (1, 'admin', 'IgDUkcLKOm7ky3L4xubaHA==','20bef587ca454e1f28558c8ef16050e4e6c1242e0cb56e4cb4c88691bc03f497' ,'admin', '2025-12-07', 'ADMIN', NULL, '0');
INSERT INTO `user` VALUES (2, '杨子翔', 'j0lMfoBkUxPXDh/p6EMU/A==','f0199c162fc77cc44c6e2a2dbd2f719e56b31e6c1de6f654156829cf002abcbc' ,'yzxyzx', '2025-12-07', 'ADMIN', NULL, '0');
INSERT INTO `user` VALUES (3, '邹循', 'dIHqZwJWP/InD5ztte0zrQ==','a663a47bee3b9ca2bbfdf9ac52cc6d4be8aaa096ba39a1f8e694ef2a927be678' ,'zxzx', '2025-12-07', 'ADMIN', NULL, '0');
INSERT INTO `user` VALUES (4, '万之现', '/7fsNhhSJJRm12K7v9ULGQ==','917f341d1a901a12c63d9719ffcfb368f1b9d03f9a9315754d4eed663486a803' ,'wzxwzx', '2025-12-07', 'ADMIN', NULL, '0');
INSERT INTO `user` VALUES (5, '王成', 'FcHpua94D0xwHLQxWMkMkQ==','5324762092842e56d1c9c427d9d565c861c8316422c134119dc7a82ecd51ed40' ,'wcwc', '2025-12-07', 'ADMIN', NULL, '0');
INSERT INTO `user` VALUES (6, '杨顺东', 'QJ4MVNsm+p4dvkKQDDUSFQ==','8963ec4528803c3249d111ba360128a489fd6e3dd88d13facbcc28b7f72d8989' ,'ysdysd', '2025-12-07', 'ADMIN', NULL, '0');
INSERT INTO `user` VALUES (7, '李民庆', 'HKmB4iqSPJkvWqtanB9yNw==','ac675bf3295f8a90163ea3e54a7988cd9441a5a8615f6ca2fb7d98fa755c68a4' ,'lmqlmq', '2025-12-07', 'ADMIN', NULL, '0');
INSERT INTO `user` VALUES (8, '一号用户', 'R5jtTu+dmXkjWRAbXSOP6g==','b03a58cf15b6ced7f0b8fc3e5f0b9f4a0d1e9a10f957bbc67fc1b198349c51df' ,'1u', '2025-12-07', 'USER', '2025-12-07', '1');
INSERT INTO `user` VALUES (9, '二号用户', '4IKv3nkTKkw6qbP2czQD1w==','a2d872495c31f8ee808d931ef63aff21f9910d880a03304e440e1fdcab9f478d' ,'2u', '2025-12-07', 'USER', NULL, '0');
...
-- book记录
-- ----------------------------
INSERT INTO `book` VALUES (1, 'Java基础案例教程（第2版）', '9787115547477', '人民邮电出版社', '传智播客', 291, 59, '2025-12-07', '0', NULL, NULL, NULL);
INSERT INTO `book` VALUES (2, '挪威的森林', '9787546205618', '上海译文出版社', '村上春树', 380, 34, '2025-12-07', '1', '杨子翔', '2025-12-07', '2026-12-07');
INSERT INTO `book` VALUES (3, '离散数学（第三版）', '9787560621579', '西安电子科技大学出版社', '方世昌', 328, 35, '2025-12-07', '1', '王成', '2025-12-07', '2026-12-07');
...
INSERT INTO `book` VALUES (10, '边城', '9787543067028', '武汉出版社', '沈从文', 368, 26, '2025-12-07', '2', '二号用户', '2025-12-07', '2026-12-07');
INSERT INTO `book` VALUES (11, '自在独行', '9787535488473', '长江文艺出版社', '贾平凹', 320, 39, '2025-12-07', '0', NULL, NULL, NULL);
INSERT INTO `book` VALUES (12, '沉默的巡游', '9787544280662', '南海出版公司', '[日]东野圭吾', 400, 59, '2025-12-07', '0', NULL, NULL, NULL);
INSERT INTO `book` VALUES (13, '计算机组成原理（第3版）', '9787040545180', '高等教育出版社', '唐朔飞', 428, 50, '2025-12-07', '0', NULL, NULL, NULL);
INSERT INTO `book` VALUES (14, '青春猪头少年不会梦到兔女郎学姐', '9787544290660', '湖南美术出版社', '[日]鸭志田一', 296, 39.80 , '2025-12-07', '1', '邹循', '2025-12-07', '2026-12-07');
INSERT INTO `book` VALUES (15, '我的青春恋爱物语果然有问题', '9787559102809', '安徽少年儿童出版社', ' [日]渡航', 224, 28, '2025-12-07', '2', '邹循', '2025-12-07', '2026-12-07');
...
-- record记录
-- ----------------------------
INSERT INTO `record` VALUES (1, 'Java基础案例教程（第2版）', '9787115547477', '杨子翔', '2025-12-07', '2025-12-08');
INSERT INTO `record` VALUES (2, 'Spark大数据分析与实战', '9787302534327', '杨子翔', '2025-12-07', '2025-12-08');
INSERT INTO `record` VALUES (3, '边城', '9787543067028', '杨子翔', '2025-12-07', '2025-12-08');
